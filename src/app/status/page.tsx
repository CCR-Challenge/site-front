const Status = () => {
    return (
        <main className="mt-[10vh] font-sans text-primary">
            <section>
                <h1 className="titulo">Status</h1>

                <h2 className="secao__subtitulo text-white">
                ...
                <ul className="list-none p-[20em] mt-[-25vh] flex flex-col gap-8">
                    <li className="flex items-center bg-[#f8f9fab6] p-6 rounded-xl shadow-md transition-transform duration-300 ease-in-out hover:cursor-pointer hover:-translate-y-1 hover:shadow-lg">
                        <div className="w-12 h-12 flex justify-center items-center mr-4">
                            <img src="/assets/bola-vermelha.png" alt="Ícone redondo vermelho" className="w-full h-auto" />
                        </div>
                    ...
                    <li className="flex items-center bg-[#f8f9fab6] p-6 rounded-xl shadow-md transition-transform duration-300 ease-in-out hover:cursor-pointer hover:-translate-y-1 hover:shadow-lg">
                        <div className="w-12 h-12 flex justify-center items-center mr-4">
                            <img src="/assets/bola-azul.png" alt="Ícone redondo azul" className="w-full h-auto" />
                        </div>
                        <div className="flex flex-col gap-1">
                    ...
                    <li className="flex items-center bg-[#f8f9fab6] p-6 rounded-xl shadow-md transition-transform duration-300 ease-in-out hover:cursor-pointer hover:-translate-y-1 hover:shadow-lg">
                        <div className="w-12 h-12 flex justify-center items-center mr-4">
                            <img src="/assets/bola-roxa.png" alt="Ícone redondo roxo" className="w-full h-auto" />
                        </div>
                        <div className="flex flex-col gap-1">
                    ...
                    <li className="flex items-center bg-[#f8f9fab6] p-6 rounded-xl shadow-md transition-transform duration-300 ease-in-out hover:cursor-pointer hover:-translate-y-1 hover:shadow-lg">
                        <div className="w-12 h-12 flex justify-center items-center mr-4">
                            <img src="/assets/bola-verde.png" alt="Ícone redondo verde" className="w-full h-auto" />
                        </div>
                        <div className="flex flex-col gap-1">
